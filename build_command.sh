...
rm ~/cloudgene_exec/cloudgene
cp ./target/cloudgene-2.8.7-assembly/cloudgene ~/cloudgene_exec/

rm ~/cloudgene_exec/cloudgene.jar
cp ./target/cloudgene-2.8.7-assembly/cloudgene.jar ~/cloudgene_exec/
