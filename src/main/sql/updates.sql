...
-- 2.8.7
create table hadoop_stats (
T TIMESTAMP NOT NULL,
APPSRUNNING CHAR(16),
TOTALNODES CHAR(16),
LOSTNODES CHAR(16),
UNHEALTHYNODES CHAR(16),
REBOOTEDNODES CHAR(16),
ACTIVENODES CHAR(16),
SHUTDOWNNODES CHAR(16),
CAPACITYTOTALGB CHAR(16),
CAPACITYUSEDGB CHAR(16),
CAPACITYREMAININGGB CHAR(16),
CORRUPTBLOCKS CHAR(16),
NUMLIVEDATANODES CHAR(16),
NUMDEADDATANODES CHAR(16),
linux_fritz_box_CURSTATE CHAR(16),
linux_fritz_box_NUMCONTAINERS CHAR(16),
linux_fritz_box_USEDMEMORYMB CHAR(16),
linux_fritz_box_AVAILMEMORYMB CHAR(16),
linux_fritz_box_USEDVIRTUALCORES CHAR(16),
linux_fritz_box_AVAILABLEVIRTUALCORES CHAR(16),
linux_fritz_box_CAPACITY CHAR(16),
linux_fritz_box_DFSUSED CHAR(16),
big_job_queue_CURSTATE CHAR(16),
big_job_queue_USEDCAPACITY CHAR(16),
big_job_queue_CAPACITY CHAR(16),
big_job_queue_MAXCAPACITY CHAR(16),
big_job_queue_NUMAPPLICATIONS CHAR(16),
big_job_queue_ALLOCATEDCONTAINERS CHAR(16),
big_job_queue_RESERVEDCONTAINERS CHAR(16),
big_job_queue_PENDINGCONTAINERS CHAR(16),
big_job_queue_NUMCONTAINERS CHAR(16),
big_job_queue_USEDMEMORY CHAR(16),
big_job_queue_USEDVCORES CHAR(16),
small_job_queue_CURSTATE CHAR(16),
small_job_queue_USEDCAPACITY CHAR(16),
small_job_queue_CAPACITY CHAR(16),
small_job_queue_MAXCAPACITY CHAR(16),
small_job_queue_NUMAPPLICATIONS CHAR(16),
small_job_queue_ALLOCATEDCONTAINERS CHAR(16),
small_job_queue_RESERVEDCONTAINERS CHAR(16),
small_job_queue_PENDINGCONTAINERS CHAR(16),
small_job_queue_NUMCONTAINERS CHAR(16),
small_job_queue_USEDMEMORY CHAR(16),
small_job_queue_USEDVCORES CHAR(16)
);
